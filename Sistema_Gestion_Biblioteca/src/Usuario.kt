sealed class Usuario {
    ...
    fun puedeTomarPrestado(libro:Libro):String {
        return when (this) {
            is Estudiante   -> "El estudiante $nombre puede tomar prestado el libro "
            is Profesor     -> "El profesor $nombre puede tomar prestado el libro"
            is Visitante    -> "El visitante $nombre nom puede tomar prestado el libro"
        }
    }
}
